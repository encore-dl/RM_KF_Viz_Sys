...
from models.demo5.multi_target_tracker import MultiTargetTracker
from models.demo5.reference_generator import ReferenceGenerator
from models.demo5.mpc_controller import MPCController
from models.demo5.shoot_decider import ShootDecider
from models.demo5.armor_selector import ArmorSelector

from models.demo5.utils.my_math import limit_rad
...
class DemoTracker5:
    ...
    def track(self):
        ...
        # 发布绘图数据
        if self.obs_armors:
            self._publish_plot_data(self.timestamp, self.obs_armors[0].rel_rpy[2], obs_pitch, pred_yaw, pred_pitch,
                                limit_rad(pred_yaw), limit_rad(gimbal.world_rpy[2]), gimbal.world_rpy[1], pitch_des)
